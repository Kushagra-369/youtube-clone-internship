...
const ChannelPage = () => {
    ...
    const handleVideoClick = async (videoId: string): Promise<void> => {
        try {
            ...
            // Navigate to video page (implement routing as needed)
        ...
        return (
            <div className="min-h-screen bg-black text-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-400">You need to be logged in to view your channel</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-black text-white">
            {channel ? (
                ...
                <div className="relative">
                    {/* Banner Section */}
                    <div className="h-48 md:h-64 bg-linear-to-r from-gray-800 to-gray-900 relative">
                        {channel.bannerUrl ? (
                            <img
                            ...
                            <div className="w-full h-full bg-linear-to-r from-gray-800 to-gray-900 flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-400">Your Banner Here</p>
                                </div>
                            </div>
                        )}
                    </div>
                        ...
                        <div className="bg-black rounded-lg p-6 shadow-xl">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className={`w-24 h-24 md:w-32 md:h-32 ${getRandomColor(channel.channelName)} rounded-full flex items-center justify-center text-4xl font-bold text-white shadow-lg`}>
                                ...
                                <button
                                    ...
                                    className="px-6 py-2 bg-red-600 hover:bg-red-700 rounded-full transition-colors text-sm font-medium flex items-center gap-2"
                                >
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        {videos.length === 0 ? (
                            <div className="bg-gray-900 rounded-lg p-12 text-center">
                                ...
                                <button
                                    onClick={() => setShowUploadModal(true)}
                                    className="px-6 py-3 bg-red-600 hover:bg-red-700 rounded-full transition-colors font-medium"
                                >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                                {videos.map((video) => (
                                    <div
                                        ...
                                        className="bg-gray-900 rounded-lg overflow-hidden hover:bg-gray-800 transition-all cursor-pointer group"
                                    >
                                        {/* Thumbnail */}
                                        <div className="relative">
                                            <img
                    ...
                    <div className="max-w-md w-full">
                        <div className="bg-gray-900 rounded-2xl p-8 text-center">
                            ...
                            <button
                                ...
                                className="px-6 py-3 bg-red-600 hover:bg-red-700 rounded-full font-semibold transition-colors w-full"
                            >
                                Create Channel
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                            ...
                            <div className="bg-gray-900 rounded-lg p-4 text-center">
                                ...
                                <p className="text-xs text-gray-400">Build subscribers</p>
                            </div>
                            <div className="bg-gray-900 rounded-lg p-4 text-center">
                                <div className="text-2xl mb-2">💰</div>
                                <h3 className="font-semibold mb-1">Monetize</h3>
                                <p className="text-xs text-gray-400">Earn from content</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-gray-900 rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                        <div className="sticky top-0 bg-gray-900 p-6 border-b border-gray-800">
                            <div className="flex justify-between items-center">
                                <h2 className="text-2xl font-bold">Create New Channel</h2>
                                <button
                                    onClick={() => {
                                        setShowCreateModal(false);
                                        resetForm();
                        ...
                        <form onSubmit={handleCreateChannel} className="p-6 space-y-4">
                            ...
                            <div className="pt-4 flex gap-3">
                                <button
                                    ...
                                    className="flex-1 px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg font-semibold transition-colors"
                                    disabled={isLoading}
                                >
                                    Cancel
                                </button>
